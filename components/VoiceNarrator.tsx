...
const VoiceNarrator: React.FC<VoiceNarratorProps> = ({ 
  ...
  return (
    <div className="max-w-2xl mx-auto bg-stone-900 p-8 rounded-[2.5rem] border border-stone-800 shadow-2xl font-sans">
      <div className="text-center mb-6">
        ...
        <h2 className="text-3xl font-black text-stone-100 tracking-tighter leading-none">{title}</h2>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-3 justify-center">
          <select 
            ...
            className="bg-stone-800 border border-stone-800 rounded-xl px-3 py-2 text-xs font-black uppercase tracking-widest cursor-pointer"
          >
        ...
        <div className="bg-stone-950 p-6 rounded-2xl border border-stone-800">
          <p className="text-stone-300 text-sm leading-relaxed mb-6 font-medium">"{text}"</p>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 flex flex-col">
              <input 
                ...
                value={progress}
                onChange={handleSeek}
                className="w-full h-1 bg-stone-800 rounded-full appearance-none cursor-pointer accent-amber-500"
              />
          ...
          <div className="flex gap-2">
            {[0.8, 1, 1.2, 1.5].map(s => (
              <button
                ...
                className={`px-2 py-1 rounded ${speed === s ? 'bg-amber-900/200 text-stone-100' : 'hover:text-stone-100'}`}
              >
                {s}x
              </button>
            ))}

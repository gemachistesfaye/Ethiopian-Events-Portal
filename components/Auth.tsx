        ...
        <>
          ...
          <div className="grid grid-cols-2 gap-3">
            <button 
              ...
              className="w-full h-12 bg-stone-50 border border-stone-200 text-stone-700 rounded-xl font-bold uppercase text-[11px] tracking-widest hover:bg-stone-100 transition-colors flex items-center justify-center gap-2"
            >
            ...
            <button 
              ...
              className="w-full h-12 bg-stone-50 text-stone-900 rounded-xl font-bold uppercase text-[11px] tracking-widest hover:bg-stone-100 transition-colors flex items-center justify-center gap-2"
            >

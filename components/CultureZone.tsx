            ...
            <div className="space-y-6">
              ...
              {!showAnswer ? (
                <button 
                  ...
                  className="bg-stone-50 text-stone-900 px-6 py-3 rounded-2xl font-bold text-[11px] uppercase tracking-widest hover:bg-amber-500 transition-all shadow-xl active:scale-95"
                >
                  Reveal Correct Answer
                </button>
              ) : (
                <div className="p-6 bg-stone-100/50 rounded-3xl border border-stone-200 animate-in zoom-in duration-500">
             ...
             <p className="text-stone-500 text-sm">Unable to load trivia. Please try again.</p>
          )}

          <div className="mt-10">
            <button 
              onClick={fetchTrivia}
              className="text-stone-500 hover:text-stone-900 transition-colors text-[11px] font-bold uppercase tracking-widest flex items-center gap-2 group"
            >

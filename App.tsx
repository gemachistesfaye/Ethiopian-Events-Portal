      ...
      <div className="grid lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-9 space-y-8">
          ...
          {activeSettingsTab === 'profile' && (
            <div className="bg-stone-100 rounded-[2.5rem] border border-stone-200 shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-300">
              {/* Profile Cover */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                  <div className="md:col-span-2 relative">
                    <input 
                      ...
                      className="w-full h-16 bg-stone-100 border-2 border-stone-200 rounded-[1.5rem] px-14 text-sm font-bold focus:border-amber-500 focus:outline-none focus:ring-4 focus:ring-amber-500/10 transition-all shadow-sm"
                    />
                  ...
                  <select 
                    ...
                    className="h-16 bg-stone-100 border-2 border-stone-200 rounded-[1.5rem] px-6 text-xs font-black uppercase tracking-widest focus:border-amber-500 focus:outline-none shadow-sm cursor-pointer"
                  >
                      ...
                      <div className="space-y-6">
                        {selectedDay.events.length > 0 ? (
                          selectedDay.events.map((event: EthiopianEvent) => (
                            <div 
                              key={event.id} 
                              className="group bg-stone-100 p-6 rounded-[2rem] border border-stone-200 hover:border-amber-400 hover:bg-stone-100 transition-all cursor-pointer shadow-sm hover:shadow-xl"
                          ...
                          <div className="py-24 text-center bg-stone-100/50 rounded-[2.5rem] border-2 border-dashed border-stone-200">
                        ...
                        <div className="pt-8 border-t border-stone-200 flex items-center justify-center">
                           <button 
                            ...
                            className="text-stone-500 hover:text-amber-600 text-[10px] font-black uppercase tracking-widest transition-colors"
                           >
...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-stone-100 border-t border-stone-200 mt-12 py-6 px-6">
          ...
          <div className="flex gap-1.5 mt-1 justify-center md:justify-end">
            {socialLinks.map((link) => (
              <a 
                ...
                className={`w-7 h-7 ${link.color} text-stone-900 rounded-md flex items-center justify-center transition-all hover:-translate-y-0.5 shadow-sm group`}
              >
                <svg 
